...
class TkFlngrPanel(TkSubEditor):
    ...
    def __init__(self, editor):
        ...
        #s_mod_depth = cf.normalized_slider(frame, "imodDepth", editor)
        ...
        #s_xmod_depth = cf.bipolar_slider(frame, "xmodDepth", editor)
        ...
        #s_mod_depth.widget().place(x=x1, y=y0, height=175)
        ...
        #s_xmod_depth.widget().place(x=x3, y=y0, height=175)
