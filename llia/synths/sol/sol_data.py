...
sol(10,"Process 1",amp=0.300,
    port=0.000,
    timebase=6.2730,
    vibrato = vibrato(ratio=1.00000,sens=0.100,depth=0.015,
                      delay=0.697,extern=0.000),
    alfo = lfo("a",ratio=3.00000,delay=0.0000),
    aenv = adsr("a",a=3.823,d=6.233,s=0.602,r=2.272,lfo_trig=0),
    blfo = lfo("b",ratio=6.00000,delay=0.0000),
    benv = adsr("b",a=0.000,d=4.206,s=0.814,r=3.714,lfo_trig=0),
    cenv=addsr(a=2.585,d1=1.315,d2=4.558,r=2.930,bp=0.762,sus=0.868,trig=1),
    opa = fmop("a",mratio=1.0000,mscale=4,mdepth=0.750,lfo=0.000,env=0.000,
               cratio=1.0000,cbias=0.0000,
               feedback=2.7480,cross_feedback=0.0000,amp=1.000),
    opb = fmop("b",mratio=8.0000,mscale=3,mdepth=0.252,lfo=0.000,env=0.000,
               cratio=4.0000,cbias=0.0000,
               feedback=0.0000,cross_feedback=0.0000,amp=0.074),
    opc = wvop("c",sratio=1.0000,pratio=2.0000,pw=0.500,pwm=0.000,
               wave=0.500,wave_lfo=0.981,wave_env=0.091,
               noise_amp=0.000,filter_track=16,filter_env=5,amp=1.000),
    opd = wvop("d",sratio=1.0000,pratio=8.0000,pw=0.500,pwm=0.000,
               wave=0.500,wave_lfo=0.000,wave_env=0.000,
               noise_amp=0.000,filter_track=16,filter_env=0,amp=0.434),
    x = vector("x",pos=0.000,ratio=0.01563,wave=0.500,delay=2.308,
               adsr=[1.610,5.196,0.957,4.293],trig=0,
               lfo_depth=-0.893, env_depth=0.798,external=0.000),
    xfilter = filter("x",freq=3062,track=0,
                     env=0,cenv=8401,lfo=0,vlfo=12938,res=0.328,amp=1.000),
    y = vector("y",pos=0.000,ratio=0.12500,wave=0.500,delay=3.828,
               adsr=[6.076,4.843,0.487,6.154],trig=0,
               lfo_depth=0.000, env_depth=0.000,external=0.000),
    yfilter = filter("y",freq=15934,track=0,
                     env=3,cenv=0,lfo=0,vlfo=0,res=0.067,amp=1.000))
