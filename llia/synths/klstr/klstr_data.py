...
klstr(18, "SynCymbal", amp=-3,
       ...
       pwLfo = 0.658,
       noise = -16,
      remarks = "Play bass notes")

klstr(19, "Klink", amp=+0,
       lfo = {"freq"    : 5.5164,
              "ratio"   : 1.0000,
              "xmod"    : 0.0000,
              "delay"   : 2.440,
...
klstr(22, "SynCymbal2(keynum 21)", amp=+5,
      lfo = {"freq"    : 2.5672,
             "ratio"   : 1.0000,
             "xmod"    : 0.0000,
             "delay"   : 1.320,
