...
class TkIoTonePanel(TkSubEditor):
    ...
    def __init__(self, editor):
        ...
        for f in (1,2,3):
            ...
            t.layout((x,y0))
            param = "amp%d" % f
            norm_slider("amp%d" % f,x,y_slider,100)
        ...
        linear_slider("modHP",(1,30),x_env+420)
        ...
        volume_slider("chiffAmp",x_chiff+180,y1)
        volume_slider("noiseAmp",x_chiff+270,y1)
        volume_slider("amp",x_chiff+360,y1)
