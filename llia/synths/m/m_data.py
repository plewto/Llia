...
m(10,"K",
   ...
   c = toneC(ratio=2.0000,
             ...
             envpitch=0.0000,
             tremolo=0.0000),
   noise = noise(lp=2624,hp=10,lag=0.4874,tremolo=0.3467),
   mix = mixer(mix=[1.0000,1.0000,0.0000,0.1778],
...
m(11,"L",
   port=0.0000,amp=0.1000,
   lfo = lfo(vFreq=5.0280,vSens=0.6061,vDepth=0.0000,xPitch=0.0000,
   ...
   mix = mixer(mix=[0.2818,1.9953,0.4467,0.1995],
...
m(12,"M",
   ...
   mix = mixer(mix=[0.6310,1.9953,0.6310,0.0891],
...
m(13,"O",
   ...
   c = toneC(ratio=0.1000,
             keyscale=[60,0,0],
             fb=-1.0000,
             pulseFreq=[1.0030,0.0000,5.0000,0.0000],
             pwm=[0.5424,0.8183,0.0000,0.0000],
             inciteSelect=0.0000,
             envpitch=0.0000,
             tremolo=0.0000),
   noise = noise(lp=20000,hp=10,lag=0.0452,tremolo=0.3970),
