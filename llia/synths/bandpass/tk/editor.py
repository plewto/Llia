# llia.synths.bandpass.tk.editor
...
def create_editor(parent):
    TkBandpassPanel(parent)

class TkBandpassPanel(TkSubEditor):

    NAME = "Bandpass"
    IMAGE_FILE = "resources/Bandpass/editor.png"
    TAB_FILE = "resources/Bandpass/tab.png"
