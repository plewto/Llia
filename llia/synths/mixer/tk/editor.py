...
class TkMixerPanel(TkSubEditor):
    ...
    def __init__(self, editor):
        ...
        def reverb_send(chan, x):
            ...
            self.add_control(param, s)
            s.widget().place(x=x, y=yrev, height=75)
        ...
        s_return = cf.volume_slider(frame, "reverbReturn", editor)
        ...
        self.add_control("reverbReturn", s_return)
        ...
        s_return.widget().place(x=x_reverb+240, y=ypan, height=175)
