...
class TkSirisFilterPanel(TkSubEditor):
    ...
    def __init__(self,editor):
        ...
        self.exp_slider("nse_lowpass", 16000, x0, y0)
        self.exp_slider("nse_highpass", 16000, x0+60,y0)
        self.norm_slider("nse_velocity", x0+120,y0)
        self.exp_slider("nse_attack", MAX_ENV_SEGMENT, x0, y1)
        self.exp_slider("nse_decay", MAX_ENV_SEGMENT, x0+60, y1)
        self.volume_slider("nse_amp", x0+120, y1)
