...
class TkBankEditor(Frame):
    ...
    def _edit_remarks(self):
        ...
        lab_title = factory.center_label(frame, "Bank Info", modal=True)
        lab_name = factory.label(frame, "Bank name :  '%s'" % name, modal=True)
        lab_filename = factory.label(frame, "Filename :  '%s'" % filename, modal=True)
        frame_text = factory.label_frame(frame, "Remarks", modal=True)
        ...
        text_widget = factory.text_widget(frame_text, "Bank remarks", modal=True)
